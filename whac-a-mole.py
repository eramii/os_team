...
class WhacAMoleGame(QMainWindow):
    def __init__(self):
        ...
        self.tip_label = QLabel("오픈소스개발방법론 5조 팀플", self)
...
#init 함수에 있던 버튼 비활성화&배경변경 기능 함수
    ...
    def game_over(self):
        ...
        msg_box = QMessageBox(self)  #error 수정
        msg_box.setWindowTitle("끝~")
...
class StartScene(QMainWindow):
    def __init__(self):
        ...
        self.lab_label = QLabel("김지수 교수님 공식 게임", self)
        self.lab_label.setFont(QFont("Malgun Gothic", 20))
        self.lab_label.setStyleSheet("color: black;")
        self.lab_label.setGeometry(230, 50, 400,150)
